...
const BARREL_PATTERNS = [
  ...
  },
  {
    ...
    message: "Import from @/shared/db barrel instead, unless using DB client/schema internals",
  },
  {
...
module.exports = defineConfig([
  ...
  // ── Pure module FP guardrails (lib/schema/utils only) ───────────────
  {
    files: [
      ...
      "features/**/schema.ts",
      "features/**/schema/**/*.ts",
      "local-ledger/domain/**/*.ts",
      "local-ledger/use-cases/**/*.ts",
      "local-ledger/ports/**/*.ts",
      "features/**/utils/**/*.ts",
      "features/**/utils/**/*.tsx",
      "shared/utils/**/*.ts",
      "shared/utils/**/*.tsx",
