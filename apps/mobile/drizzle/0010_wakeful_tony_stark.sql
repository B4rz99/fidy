...
INSERT INTO `merchant_rules_new` SELECT MAX(`id`), `user_id`, `keyword`, MAX(`category_id`), MAX(`created_at`) FROM `merchant_rules` GROUP BY `user_id`, `keyword`;--> statement-breakpoint
