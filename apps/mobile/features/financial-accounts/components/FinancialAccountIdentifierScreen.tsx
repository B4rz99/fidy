...
export function FinancialAccountIdentifierScreen() {
  ...
  if (!accountId || !accountDetails || !accountCanHaveIdentifiers) {
    return (
      <ScreenLayout
        title={t("financialAccounts.identifierScreen.title")}
        variant="sub"
        onBack={back}
      >
  ...
  const handleSave = () => {
    void guardedSave(async () => {
      try {
        ...
        showErrorToast(t("financialAccounts.identifierScreen.saveFailed"));
      }
    });
  };

  return (
    <ScreenLayout title={t("financialAccounts.identifierScreen.title")} variant="sub" onBack={back}>
      <ScrollView
      ...
      >
        <Text style={[styles.subtitle, { color: secondary }]}>
          {t("financialAccounts.identifierScreen.subtitle")}
        </Text>
