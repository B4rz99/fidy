const en = {
  ...
  accounts: {
    title: "Accounts",
    subtitle: "Track the cash, cards, and banks that should own each ledger balance.",
    createTitle: "Create Account",
    createSubtitle: "Add a real-world account so new balances land in the right place.",
    add: "New account",
    save: "Create account",
    emptyTitle: "No financial accounts yet",
    emptySubtitle: "Create your first account to start shaping your ledger.",
    openingBalance: "Opening balance",
    subtypeLabel: "Account type",
    institutionLabel: "Institution",
    institutionPlaceholder: "e.g. Bancolombia",
    namePlaceholder: "e.g. Visa Gold",
    last4Label: "Last 4 digits",
    last4Placeholder: "1234",
    last4Helper: "Leave blank or enter exactly 4 digits.",
    balanceLabel: "Balance",
    balanceDateLabel: "Balance date",
    creditCardFields: "Credit card details",
    creditLimitLabel: "Credit limit",
    closingDayLabel: "Closing day",
    dueDayLabel: "Due day",
    dayHelper: "Use calendar days from 1 to 31.",
    subtypes: {
      checking: "Checking",
      savings: "Savings",
      cash: "Cash",
      digitalHolding: "Digital holding",
