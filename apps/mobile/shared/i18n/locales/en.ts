const en = {
  ...
  categories: {
    ...
    create: {
      ...
      namePlaceholder: "Pets",
      iconLabel: "Choose an icon",
      customEmojiLabel: "Or type an emoji",
    ...
    appearance: {
      ...
      presetEmojiLabel: "Suggested emoji",
      colorLabel: "Color",
      save: "Save changes",
      resetEmoji: "Use default emoji",
  ...
  goals: {
    ...
    create: {
      title: "Create goal",
      goalName: "Goal name",
      goalNamePlaceholder: "Trip to Holland",
    ...
    payment: {
      ...
      notePlaceholder: "Monthly savings",
      date: "Date",
    },
    milestones: {
  ...
  settings: {
    ...
    deleteAccountWarning:
      "This will permanently delete your account, Cloud Ledger financial records, private backups, linked capture improvement samples, and operational account data. This cannot be recovered.",
  ...
  analytics: {
    ...
    selectedCategoryExpenses: "%{category} expenses",
    unnamedExpense: "Expense",
